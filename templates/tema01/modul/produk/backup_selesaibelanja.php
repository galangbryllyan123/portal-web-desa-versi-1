  ...
  Barang yang dipesan akan dikirim sesuai alamat yang tertera diatas. setelah melakukan konfirmasi pembayaran.</p>
  <br/>
  <input type=button class='button' value='Selesai Belanja Sekarang' 
  onclick=\"window.location.href='aksi.php?act=simpantransaksi';\">
  </form>
  </div>";}
  ...
  <textarea required name=alamat style='width:950%; height:100px;'></textarea>
  </div>				
  </td>			
  </tr>
  ...
  echo "
  <div class='box box-common'>
  <h3 class='heading-title'>Keranjang Belanja Anda</h3>
  <div class='cart-info'>
  ...
  $no=1;
  $sql2 = mysqli_query($koneksi,"SELECT * FROM orders_temp, produk WHERE id_session='$sid' AND orders_temp.id_produk=produk.id_produk");

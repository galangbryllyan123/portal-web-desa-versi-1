  ...
  <!--========= DETAIL PRODUK  ========================-->  
  <?php
  $detail=mysqli_query($koneksi,"SELECT * FROM produk,kategori,users    
  ...
  mysqli_query($koneksi,"UPDATE produk SET dibaca='$baca' where id_produk='".$val->validasi($_GET['id'],'sql')."'");
  mysqli_query($koneksi,"UPDATE produk SET dibeli='$beli' where id_produk='".$val->validasi($_GET['id'],'sql')."'");
  ...
  $g = mysqli_query($koneksi,"SELECT * FROM gallery WHERE id_produk='".$val->validasi($_GET['id'],'sql')."'  
  ...
  <div class='summary'>
  <div class='price'>
  <span class='product-price'>Harga : Rp ". number_format($r['harga']) .",-</span>
  ...
  <div class='cart'><!------///maunya tidak pake---->
  $tombol  
  
<!------tidak perlu share icons--->
  ...
  </div> <!--////class marginshare ends///////---->
  </div> <!--////////////class addthis ends----->
  <script type='text/javascript' src='http://s7.addthis.com/js/250/addthis_widget.js#pubid=ra-504c13fd103cdd62'>
  </script><!--////////tidak pake/////////----->
  ...
  //NEXT-PREV produk ///////////////////////////////////////////////////////////////////////
  $qp = mysqli_query($koneksi,"select id_produk, nama_produk, produk_seo from
  ...
  $qn = mysqli_query($koneksi,"select id_produk, nama_produk, produk_seo from
  ...
  <!--========= AKHIR DETAIL PRODUK  ========================-->  
   ...
   $sql=mysqli_query($koneksi,"SELECT * FROM kategori, produk  
   ...
   <div class='price_hold'><!------///maunya tidak pake///////////--------->
   
   </div>
   $tombol <!------///maunya tidak pake---------------->
   </div></div>";}
   echo "
   </div>";
   ?>

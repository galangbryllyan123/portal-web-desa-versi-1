  ...
  echo "	
  <div class='meta'>
  <span class='posted_in'>Diposting: $r[nama_lengkap] | 
  <span class='posted_by'>$tgl</span> 
  <span class='count_comments'>Dilihat: $baca pengunjung</span> 
  </div>";
  ...
  echo "<span class style=\"color:#ccc;font-size:11px;padding-top:20px;\">Gambar lain tidak tersedia.</span>";}
  ...
  <h5 class='text-orange'>Deskripsi: </h5>

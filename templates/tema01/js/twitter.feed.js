	...
	$.extend(TwitterFeedObject.prototype, {
		...
		create: function(el, options) {
			...
			this.defaults = {
				...
				results: 15, // number of results to display
			...
			jQuery.ajax({
				...
				success: function(a){
					...
					$.each(a, function(i,item){
						...
						// Add twitter feed items to ticker 
						$('.ticker ',el).append(html).slideDown();
					});
				},
				complete: function(){
					
					// Code to open new popup window for share links + open other links in new browser tab
					$('.ticker  a',el).click(function(e){

...
session_start();
 if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){  
  ...
  <strong>Anda berhasil</strong> meng-update Cara Pembelian.
  </div>";}
  
  $sql  = mysqli_query($koneksi,"SELECT * FROM carabeli");
  ...
  <div class='span9'><textarea name='isi_carabeli' id='teraskreasi' style='height: 350px;'>$r[isi_carabeli]
  </textarea></div>
  <div class='clear'></div>
  </div>      

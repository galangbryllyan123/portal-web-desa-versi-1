...
session_start();
  ...
  $tampil = mysqli_query($koneksi,"SELECT * FROM newsletter ORDER BY id DESC");}
  
  else{
  $tampil=mysqli_query($koneksi,"SELECT * FROM newsletter 
  ...
  case "editnewsletter":
  $edit=mysqli_query($koneksi,"SELECT * FROM newsletter WHERE id='$_GET[id]'");

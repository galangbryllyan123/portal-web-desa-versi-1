...
$direktori = "../files_download/"; // folder tempat penyimpanan file yang boleh didownload
$filename = $_GET['file'];
...
if ($file_extension=='php'){
  echo "<h1>Access forbidden!</h1>
        ...
        Silahkan hubungi <a href='mailto:simri_n@yahoo.com'>webmaster</a>.</p>";// Silahkan ganti dengan email Anda
  exit;
}
else{
